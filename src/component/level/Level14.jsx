...
function Level14({ selectedLevel }) {
  const [font, setFont] = useState('');
  const [cards, setCards] = useState([]);
  const [flippedIndices, setFlippedIndices] = useState([]);
  const [matchedIndices, setMatchedIndices] = useState([]);
  const [score, setScore] = useState(0);
  const [time, setTime] = useState(140);
  ...
  useEffect(() => {
    const symbols = ['./img/book.webp', './img/dimants.webp', './img/emerald.webp', './img/gold.webp', './img/purple.png', './img/stone.webp', './img/sand.webp', './img/green.webp', './img/birch.png'];
    const initialCards = [];
