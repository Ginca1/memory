...
function Level18({ selectedLevel }) {
  ...
  useEffect(() => {
    const symbols = ['./img/book.webp', './img/dimants.webp', './img/emerald.webp', './img/gold.webp', './img/purple.png', './img/stone.webp', './img/sand.webp', './img/green.webp' , './img/birch.png' , './img/tnt.png' , './img/lava.webp'];
    const initialCards = [];
          ...
          <div className="card-container">
            <div className="row">
              {cards.map((card, index) => (
                <div
                  key={index}
                  className={`card3 ${flippedIndices.includes(index) ? 'flipped' : ''} ${matchedIndices.includes(index) ? 'matched' : ''}`}
