...
function Level20({ selectedLevel }) {
  ...
  useEffect(() => {
    const symbols = ['./img/book.webp', './img/dimants.webp', './img/emerald.webp', './img/gold.webp', './img/purple.png', './img/stone.webp', './img/sand.webp', './img/green.webp' , './img/birch.png' , './img/tnt.png' , './img/lava.webp', './img/chest.webp'];
    const initialCards = [];
          ...
          <div className="card-container">
            <div className="row">
              {cards.map((card, index) => (
                <div
                  key={index}
                  className={`card4 ${flippedIndices.includes(index) ? 'flipped' : ''} ${matchedIndices.includes(index) ? 'matched' : ''}`}
