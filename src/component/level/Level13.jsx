...
function Level13({ selectedLevel }) {
  ...
  useEffect(() => {
    const symbols = ['./img/book.webp', './img/dimants.webp', './img/emerald.webp', './img/gold.webp', './img/purple.png', './img/stone.webp', './img/sand.webp', './img/green.webp'];
    const initialCards = [];
